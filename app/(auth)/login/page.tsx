  ...
  return (
    <>
      <style>{`
        ...
        .phone-illustration{
          position:relative;width:400px;height:520px;margin:0 auto 32px;
          filter:drop-shadow(0 30px 60px rgba(123,92,245,0.25));
        }
        ...
        <div className="login-left">
          <div className="phone-illustration">
            ...
            <img
              ...
              alt="Social AI phone"
              style={{ width: 440, height: 'auto', objectFit: 'contain', display: 'block', margin: '0 auto', filter: 'drop-shadow(0 20px 40px rgba(123,92,245,0.25))' }}
            />
          </div>
